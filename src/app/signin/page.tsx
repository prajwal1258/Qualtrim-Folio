...
export default function SignIn() {
    ...
    return (
        <div className="h-svh w-screen flex items-center justify-center relative bg-black selection:bg-white selection:text-black font-light text-white">
            ...
            <div className="z-10 w-full max-w-md px-8 py-12 bg-black/40 backdrop-blur-xl border border-white/10 rounded-sm">
                <div className="mb-8">
                    <h1 className="text-3xl tracking-tighter mb-2">Welcome Back</h1>
                    <p className="text-white/60 text-sm">Enter your credentials to access your folio.</p>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-white text-black font-medium hover:bg-white/90 transition-all active:scale-[0.98] rounded-sm mt-4 flex items-center justify-center gap-2"
                    >
                        {isSubmitting ? (
                            <>
                ...
                <div className="mt-8 text-center text-sm">
                    ...
                    <Link href="/signup" className="text-white hover:underline decoration-white/30 underline-offset-4">Sign Up</Link>
                </div>
            </div>

            <div className="absolute bottom-8 right-8 z-10 hidden md:block">
                <p className="text-xs tracking-widest text-white/20 uppercase">
                    Qualtrim Folio — Secure Access
                </p>
            </div>
        </div>
    );
